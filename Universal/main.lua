...
if GlobalEnvironment().beachwave then
    GlobalEnvironment().beachwave.Unload() -- return end?
end
...
local OutlineLerp = CIELUVInterpolator:Lerp(Color3.fromRGB(255, 255, 255), Color3.fromRGB(0, 0, 0))
Library.flags["Aimbot Active"] = false
...
RunService:BindToRenderStep(LoopId, 1, function()
    ...
    for Index, Player in pairs(Players:GetPlayers()) do
        ...
        if IsPlayerAlive and Health and BodyParts and PlayerColor and PassedTeamCheck then
            ...
            Objects.Info.Main.Color = OutlineLerp(HealthPercent)
            Objects.Info.Extra.Color = Objects.Info.Main.Color

            Objects.Info.Main.OutlineColor = Objects.Healthbar.Main.Color
            Objects.Info.Extra.OutlineColor = Objects.Healthbar.Main.Color
        end
